...
<body>
	...
	<div id="wrap" align="center">
		<br> '${loginUser.userid}'님 환영합니다.&nbsp; <input type="button"
			...
			type="button" value="메인페이지" onclick="location.href='login.do'"
			class="w3-button w3-round w3-padding-small w3-green"> <input
			type="button" value="오늘의 날씨" onclick="location.href='weather.jsp'"
			class="w3-button w3-round w3-padding-small w3-dark-grey"> <input
		...
		<div id="wrap_right">
			<a href="BoardServlet?command=board_write_form"><img
				src="./img/edit2.png" width="17px">게시글 쓰기 </a>
		</div>
		<table id="list" class="w3-table w3-bordered w3-hoverable">
			...
			<c:forEach var="board" items="${boardList }">
				<tr class="record">
					<td>${board.num}</td>
					<td><a
						href="BoardServlet?command=board_view&num=${board.num}&page=${currentPage}">${board.title}</a>
		...
		<table>
			<tr>
				...
				<c:forEach var="i" begin="${startPage}" end="${endPage}"
					varStatus="cnt">
					<a href="./BoardServlet?command=board_list&page=${i}">[ <font
				...
				<c:if test="${endPage!=totalPage}">
					<a href="./BoardServlet?command=board_list&page=${endPage+1}">다음
						▶</a>
				</c:if>
			</tr>
